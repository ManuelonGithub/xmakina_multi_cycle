...
HD_PWD='C:/Users/Manuel/Desktop/xmakina_multi_cycle/Vivado Projects/XMakina_MultiCycle/XMakina_MultiCycle.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xm_cpu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xm_cpu.tcl
